...
const PageHero = ({ title, intro }: PageHeroProps) => {
  return (
    <section className="aspect-1920/650 w-full overflow-hidden bg-[url('/image/hero/PageHeroLightGR.png')] bg-cover bg-bottom px-5 py-30 md:aspect-1920/500 md:px-9.75 md:py-25">
